        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item has-treeview {{ request()->is('student*') || request()->is('grade*') ? 'menu-open' : '' }}">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('student.select_section') }}" class="nav-link {{ request()->is('student/select_section/form') || request()->is('student')  ? 'active' : '' }}">
                          <i class="far fa-circle nav-icon"></i>
                          <p>قائمة الطلبة</p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('grade.old_grade_sheet_form') }}" class="nav-link {{ request()->is('grade/old_grade_sheet_form') || request()->is('grade/old_grade_sheet*') ? 'active' : '' }}">
                          <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('student.grade_equation_section_select_form') }}" class="nav-link {{ request()->is('student/grade_equation*') ? 'active' : '' }}">
                          <i class="far fa-circle nav-icon"></i>
                          <p>معادلة للطلبة</p>
                        </a>
                    </li>
                    ...
                    @if (auth()->user()->show_graduated == 1)
                        <li class="nav-item">
                            <a href="{{ route('student.graduated_students') }}" class="nav-link {{ request()->is('student/graduated/students*') ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
                            <p>الخريجين</p>
                            </a>
                        </li>
            ...
            <li class="nav-item has-treeview {{ request()->is('treasury*') ? 'menu-open' : '' }}">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('treasury.index') }}" class="nav-link {{ request()->is('treasury') ? 'active' : '' }}">
                          <i class="far fa-circle nav-icon"></i>
            ...
            <li class="nav-item has-treeview {{ request()->is('reports*') ? 'menu-open' : '' }}">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('reports.season_resault_search_form') }}" class="nav-link {{ request()->is('reports/season_resault_search/form') || request()->is('reports/season_resault_search*') ? 'active' : '' }}">
                          <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('reports.students_inroll_form') }}" class="nav-link {{ request()->is('reports/students_inroll_form') || request()->is('reports/students_inroll*') ? 'active' : '' }}">
                          <i class="far fa-circle nav-icon"></i>
                          <p>كشوفات الطلبة</p>
                        </a>
                      </li>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('reports.student_payments_form') }}" class="nav-link {{ request()->is('reports/student_payments_form') || request()->is('reports/student_payments*') ? 'active' : '' }}">
                          <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('reports.employee_season_salary_form') }}" class="nav-link {{ request()->is('reports/employee_season_salary*') ? 'active' : '' }}">
                          <i class="far fa-circle nav-icon"></i>
                          <p>كشوفات المرتبات</p>
                        </a>
                      </li>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('reports.account_statement_form') }}" class="nav-link {{ request()->is('reports/account_statement*') ? 'active' : '' }}">
                          <i class="far fa-circle nav-icon"></i>
