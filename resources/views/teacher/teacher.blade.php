        ...
        <tbody>
            ...
            @foreach ($teachers as $teacher)
                <tr>
                    ...
                    <td>{{ $teacher->phone }}</td>
                    <td>
                        <a href="{{ route('teacher.teacherSalary', $teacher->id) }}" class="btn btn-success"><i class="fa-solid fa-money-bills"></i></a>
                        <a href="{{ route('teacher.courses', $teacher->id) }}" class="btn btn-warning"><i class="fa-solid fa-book"></i></a>
                        <a href="{{ route('teacher.edit', $teacher->id) }}" class="btn btn-info"><i class="fa-solid fa-user-pen"></i></a>
                        <a href="{{ route('teacher.show', $teacher->id) }}" class="btn btn-secondary"><i class="fa-solid fa-eye"></i></a>
                        <form action="{{ route('teacher.destroy', $teacher->id) }}" method="post" class="d-inline form_delete">
                            @csrf
                            @method('DELETE')
...
@section('section_modals')
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <h5 class="modal-title" id="exampleModalLabel">اضافة مدرس</h5>
